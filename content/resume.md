...
Software Engineer: Backend, Systems, QA
...
I wrote and maintained an end-to-end testing suite written with an internal domain specific language to catch
regressions, add coverage for under-tested features, and test new features to greenlight their release.

I fixed bugs that I found in Hydra Studio, and added features to the internal testing DSL to expand its test coverage capabilities. I wrote load testing
...
litigation. I lead a refactoring effort to consolidate and simplify UI and maintained the automated testing system I had created as an intern.

**June 2018 - August 2018** - QA Intern

I replaced a frontend testing suite using the deprecated CasperJS framework with a new one using the NodeJS Puppeteer and Mocha frameworks.
...
which allow you to make web requests and then make assertions against returned data.
